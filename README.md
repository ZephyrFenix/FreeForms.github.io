FreeForms is a javascript based program meant to be used to create forms for different purposes. This could be as simple as a grocery list, or as complicated as a character sheet for a tabletop rpg.
